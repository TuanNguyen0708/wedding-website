...
export default function RootLayout({
  ...
  return (
    ...
    >
      <head>
        <script src="http://localhost:5173/chat-widget/out/bootstrap.js" data-widget="eyJ3aWRnZXRJZCI6IjAwMDAwMDAwLTAwMDAtMDAwMC0wMDAwLTAwMDAwMDAwMDAwMCIsInRlbmFudElkIjoiZGRlOTNiNDAtZDFiYS00MDI5LTg5NmMtNDc3ZTg4MWI1YmI3In0" async defer ></script>
