...
export default function RootLayout({
  ...
  return (
    ...
    >
      <head>
        <script src="https://nextdev.akabot.io/chat-widget/bootstrap.js" data-external="true" data-widget="eyJ3aWRnZXRJZCI6IjEwMDAwMDAwLTAwMDAtMDAwMC0wMDAwLTAwMDAwMDAwMDAwMCIsInRlbmFudElkIjoiZGRlOTNiNDAtZDFiYS00MDI5LTg5NmMtNDc3ZTg4MWI1YmI3In0" async defer></script>
